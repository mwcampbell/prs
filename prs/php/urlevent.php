...
?>
<input type = "hidden" name="event_type" id="event_type" value="url">
<label for="detail1">Enter URL:</label>
<input type = "text" name = "detail1" id="detail1">
<label for="detail2">Enter length in seconds:</label>
<input type = "text" name="detail2" id="detail2">
<label for="detail3">Enter archive File Name:</label>
